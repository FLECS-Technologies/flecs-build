...
set(REGISTRY_PATH $ENV{REGISTRY_PATH})
...
add_custom_command(
    ...
    COMMAND docker buildx build --load --build-arg MACHINE=${MACHINE} --build-arg ARCH=${ARCH} --build-arg VERSION=${VERSION} --platform ${DOCKER_ARCH} --tag ${REGISTRY_PATH}/${DOCKER_IMAGE}:${DOCKER_TAG} ${CMAKE_CURRENT_BINARY_DIR}
)
